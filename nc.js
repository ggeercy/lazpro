      ...
      !(function (e) {
        ...
        function (e, t, n) {
          ...
          function o(e, t, n) {
            if (e) {
              ...
              else for (o in e) if (e.hasOwnProperty(o) && t.call(n, e[o], o, e) === !1) break;
            }
          }
          function i(e, t) {
            if (!t) return !1;
          ...
          (t.getClientRect = function (e) {
            ...
            (t.getOffset = function (e) {
              ...
              var n = h(t),
                o = { x: u.pageXOffset + e.clientX, y: u.pageYOffset + e.clientY };
        ...
        function (e, t, n) {
          ...
          (i.getImgSize = function (e, t) {
            ...
            (i.fill = function (e, t) {
              ...
              else for (var n = 0, o = e.length; n < o; n++) e[n] = t;
              return e;
            }),
            (e.exports = i);
        },
        ...
        function (e, t, n) {
          ...
          (t.names = {
            ...
            (t.deprecated = { slide_start: 'actionstart', slide_end: 'actionend', before_code: 'beforeverify', after_code: 'afterverify', error300: 'error' });
        },
        function (e, t) {
          function n(e, t) {
        ...
        function (e, t, n) {
          ...
          t.makeLog = function (e) {
            ...
            function n(t) {
              o.console && void 0;
              var n = e + 'jstracker.2',
                r = i.obj2param({ type: '9', id: 'jstracker', v: '1', nick: '', islogin: '', msg: t, file: '', ua: '', line: '', scrolltop: '', screen: '', t: +new Date() });
              i.send(n + '?' + r);
            }
            e = e || '//gm.mmstat.com/';
            var r = e + 'aq.1.1.3',
          ...
          Object.getPrototypeOf ||
            ...
            (function () {
              if (
                ...
                Object.defineProperty = function (t, n, o) {
                  ...
                  return (
                    Object.prototype.__defineGetter__ && 'get' in o && Object.prototype.__defineGetter__.call(t, n, o.get),
            ...
            Date.prototype.toISOString ||
              (Date.prototype.toISOString = function () {
                ...
                return (
                  this.getUTCFullYear() + '-' + e(this.getUTCMonth() + 1) + '-' + e(this.getUTCDate()) + 'T' + e(this.getUTCHours()) + ':' + e(this.getUTCMinutes()) + ':' + e(this.getUTCSeconds()) + '.' + t(this.getUTCMilliseconds()) + 'Z'
                );
              });
        },
        function (e, t, n) {
            ...
            (window.__sc_uaboption = new Object()),
              e.is_Opt
                ? ((UA_Opt.MPInterval = o('MPInterval', 4)),
                  ...
                  (window.__sc_uaboption.mIDs = o('mIDs', ['nc-canvas', 'click2slide-btn'])))
          ...
          function o(e, t, n) {
            var o = e.prefix,
              ...
              y = new s(function (e, t) {
                return b
                  ? void t()
                  : void d.imageLoaded('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==').then(function (n) {
              ...
              k = function (e) {
                ...
                (this.service = {
                  ...
                  (this.cache = { codeType: 'img', oldCode: null, lastCheckCode: '', checkedCode: null, checkState: 'notstart', audio: null, audioPlayer: null, callback: null, captchaToken: null });
              };
            return (
              (k.prototype = {
                render: function () {
                ...
                renderCode: function () {
                  ...
                  function i() {
                    ...
                    try {
                      noCaptcha.getByIndex(parseInt(o)).reload(), n(c.switchevent, { from: 'audio', to: 'scale' });
                    } catch (i) {
                ...
                switchCode: function (e) {
                  'img' == e.type
                    ? (this.stopAudio(), (m(o + 'omeo-code').className = 'omeo-code omeo-img-active'))
                    : ((m(o + 'omeo-code').className = 'omeo-code omeo-audio-active'), this.resetPlayer({ state: 'playing' }), !this.audioSupport || p || (m(o + 'omeo-refresh-audio').style.display = ''), this.playAudio()),
                ...
                playAudio: function (e) {
                  function t(t) {
                    ...
                    if (this.audioSupport)
                      (this.cache.audio = new Audio()), (c = r.createElement('source')), (c.type = n), (c.src = e), this.cache.audio.appendChild(c), this.cache.audio.load(), this.cache.audio.play(), this.bindAudioProgress();
                    else if (this.isIE) {
                ...
                loadResource: function (e, t) {
                  var n = null;
                  /\.css/g.test(e) ? (r.createStyleSheet && r.createStyleSheet(e), (n = r.createElement('link')), (n.rel = 'stylesheet'), (n.href = e)) : ((n = r.createElement('script')), (n.src = e)),
                    'onload' in n
                      ? (n.onload = function () {
                          t && t();
                        })
        ...
        function (e, t, n) {
          ...
          var s = window,
            ...
            m = new p(function (e, t) {
              return h
                ? void t()
                : void r('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==').then(function (n) {
                    1 === n.width && 1 === n.height ? e() : t();
                  }, t);
            }),
            ...
            (o.prototype = {
              ...
              render: function () {
                ...
                (this.$container.innerHTML = t),
                  ...
                  this.pin(),
                  _.each(
                    ['body', 'footer', 'tip', 'confirm', 'wait', 'refresh', 'mask'],
                    function (e) {
              ...
              pin: function () {
                var e = this.options.$wrapper,
                  ...
                  a = '';
                r - t - n > i ? ((a = 'right'), (this.$container.style.left = (t - 150) / 2 + 108 + 30 + 'px')) : n > i && ((a = 'left'), (this.$container.style.left = -(i + 25 - (t - 150) / 2) + 'px')),
              ...
              updateCaptcha: function (e) {
                ...
                if (this.status !== w.LOADING) {
                  ...
                  var o = m
                    ...
                    .then(function (e) {
                      var n = t.options;
                      return i({ url: e, data: { sessionid: n.csessionid, identity: n.appkey, style: n.value, type: 'SUDOKU_IMG', token: n.token } });
                    })
                    .then(function (e) {
                      return t.hasDestroy()
                        ? v
                        : e.success && 0 === e.result.resultCode
                        ? ((t.captchaToken = e.result.captchaToken), p.all([r(e.result.data[0]), r(e.result.data[1])]))
                        : p.reject({ type: 'request', code: e.result.resultCode, msg: e.result.message });
                    })
                    .then(function (e) {
        ...
        function (module, exports, __webpack_require__) {
          ...
          function makeNoCaptcha(module_nc, opt, inn_vars, nc_events, Scale, onNCEvent, _) {
            ...
            function showError(e, t) {
              ...
              if (e) {
                if (((n = language[opt.language]._errorNetwork + o), 'function' == typeof opt.errorCallback))
                  try {
                    opt.errorCallback(t);
                  } catch (i) {}
            ...
            var supportDataURI = new Promise(function (e, t) {
              return isIE8
                ? void t()
                : void util.imageLoaded('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==').then(function (n) {
                    1 === n.width && 1 === n.height ? e() : t();
                  }, t);
            });
            return (
              (NoCaptcha.prototype = {
                init: function (e) {
                  ...
                  e.foreign && ((t = 'en'), (default_opt.language = t)),
                    'CF_APP_WAF' != e.appkey ||
                      (e.foreign && 0 != e.foreign) ||
                      (e.apimap = { analyze: 'https://cf-app-waf.cfc.aliyuncs.com/nocaptcha/analyze.jsonp', initialize: 'https://cf-app-waf.cfc.aliyuncs.com/nocaptcha/initialize.jsonp' }),
                  ...
                  if ((language[opt.language] || (opt.language = t), e.upLang)) for (var s in e.upLang) _upLang(s, e.upLang[s]);
                ...
                updateCSS: function (e, t, n) {
                  var o = util.isIEX(6),
                    ...
                    r = o || i ? ' !important' : '';
                  css.insertCSS(
                    (n ? '' : '.nc-container #' + e + 'wrapper,.nc-container.tb-login #' + e + 'wrapper{width:' + t + 'px}\n') +
                      ['.nc-container .imgCaptcha', '.nc-container .clickCaptcha'].join(',') +
                      '{width:' +
                      (t - 2) +
                      'px' +
                      r +
                      ';}\n' +
                      ['.nc-container.tb-login .imgCaptcha', '.nc-container.tb-login .clickCaptcha'].join(',') +
                      '{width:' +
                      t +
                      'px' +
                      r +
                      ';}\n' +
                      ['.nc-container.tb-login .imgCaptcha .captcha-error', '.nc-container.tb-login .clickCaptcha .captcha-error'].join(',') +
                      '{width:' +
                      (t - 8) +
                      'px' +
                      r +
                ...
                initUaParam: function () {
                  ...
                  opt.is_Opt
                    ? (e('MPInterval', 4), e('MaxMCLog', 12), e('MaxKSLog', 14), e('MaxMPLog', 5), e('MaxFocusLog', 6), e('SendInterval', 5), e('SendMethod', 8), e('GPInterval', 50), e('MaxGPLog', 1), e('MaxTCLog', 12), e('Flag', 2980046))
                    : ((UA_Opt.SendInterval = 5),
                      (UA_Opt.SendMethod = 8),
                      (UA_Opt.MaxMCLog = 12),
                      (UA_Opt.MaxKSLog = 14),
                            ...
                            if ('loaded' === t) {
                              var o = function r() {
                                ...
                                (t = t.length < 128 ? t : t.substring(0, 128)),
                                  ...
                                  n.init({ timeout: opt.timeout, serviceUrl: ajaxURL.umid_serUrl, appName: opt.appkey, enableFY: 1, jf: 1, wtac: 1 }, function (n, o) {
                        ...
                        function o(e) {
                          if (e.success)
                            if (100 == e.result.code) n.userCallback(objCheckCode.config.sessionid, e.result.value, e.result.sig);
                              ...
                              (300 != e.result.code && 69634 != e.result.code) ||
                                (report('block'),
                                (_.id(opt.renderTo).innerHTML =
                                  '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + '</i>' + _upResetIndex(language[opt.language]._error300).replace('<a href', '<a id=' + nc_prefix + 'refresh1 href') + '</div>'),
                        ...
                        if (e) {
                          ...
                          r &&
                            (objCheckCode ||
                              ...
                              objCheckCode.render(),
                              onNCEvent(event_names.switchevent, { from: 'scale', to: 'audio' }),
                              objCheckCode.switchCode({ type: 'audio' })));
                        }
                      }
                      var i = _.id(nc_prefix + '_voice');
                      if (((_.id(nc_prefix + 'imgCaptcha').style.display = 'none'), (_.id(nc_prefix + 'clickCaptcha').style.display = 'none'), e))
                        return (e = !1), (i.style.display = 'none'), objCheckCode && objCheckCode.stopAudio(), clearInterval(win.__progtid), n.reset(), !1;
                ...
                reload: function () {
                  ...
                  e && ((e.innerHTML = tpl), util.addClass(el_render_to, 'nc-container')),
                  ...
                  t &&
                    (navigator.userAgent.indexOf('MSIE 6.0') >= 0 && (t.style.display = 'none'),
                ...
                onScaleReadyCallback: function (e, t) {
                  if (e.success) {
                    ...
                    if (0 === o)
                      ...
                      (UA_Opt.reload && ((UA_Opt.Token = new Date().getTime() + ':' + opt.token), UA_Opt.reload && UA_Opt.reload()),
                      ...
                      if (
                        ...
                        (_.id(opt.renderTo).innerHTML =
                          ...
                          icon_warn +
                          '</i>' +
                          _upResetIndex(language[opt.language]._error300).replace('<a href', '<a id=' + nc_prefix + 'refresh1 href') +
                          '(error:' +
                          r +
                          ')</div>'),
                      ...
                      .then(function (e) {
                        _.jsonp({
                          ...
                          success: function (e) {
                            if (
                              (e.result.question &&
                                ((e.result.question = e.result.question.replace(/<span[^>]+?>/g, '<i>')), (e.result.question = e.result.question.replace(/<\/span[^>]*?>/g, '</i>')), (r.captchaToken = e.result.captchaToken)),
                              (s = !0),
                              l != -1)
                            ) {
                              ...
                              util.removeClass(inn_vars.TEXTELEM, 'nc-align-center'),
                                _.id(nc_prefix + '_scale_text') &&
                                  (e.result.question.indexOf('<i>') == -1
                                    ? (_.id(nc_prefix + '_scale_text').innerHTML = p + '<i>\u201c' + e.result.tags[0] + '\u201d</i>' + u.join(e.result.tags[0]))
                                    : (_.id(nc_prefix + '_scale_text').innerHTML = e.result.question)),
                ...
                onScale200: function t(e, n) {
                        ...
                        success: function (t) {
                          if (t.success) {
                            ...
                            if (100 == t.result.code)
                              ...
                              (300 != t.result.code && 69634 != t.result.code) ||
                                (report('block'),
                                (_.id(opt.renderTo).innerHTML =
                                  '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + '</i>' + _upResetIndex(language[opt.language]._error300).replace('<a href', '<a id=' + nc_prefix + 'refresh1 href') + '</div>'),
                                onNCEvent(event_names.error),
                  ...
                  var c = t,
                    ...
                    d = supportDataURI
                      ...
                      .then(function (t) {
                        var o = opt;
                        return util.request({ url: t, data: { sessionid: e, identity: o.appkey, token: opt.token, style: n } });
                      })
                      .then(function (e) {
                  ...
                  this.__inn &&
                    ...
                    window.addEventListener
                      ? _.id(nc_prefix + 'captcha_input').addEventListener('input', o)
                      : _.id(nc_prefix + 'captcha_input').attachEvent('onpropertychange', function (e) {
                ...
                destroy: function () {
                  ...
                  var e,
                    t,
                    n,
                    o = util.getElementsByClassName('nc-custom-style-' + nc_index);
        ...
        function (e, t, n) {
          ...
          function i(e, t, n) {
            function i(e, n, i) {
              t.TEXTELEM && ((t.TEXTELEM.innerHTML = s[i.opt.language || l.language]._startTEXT), o() && c.addClass(t.TEXTELEM, 'slidetounlock')),
                    ...
                    o = setInterval(function () {
                      (t += 5),
                        t > n
                          ...
                          : ((f.style.left = s + 20 + t + 'px'), (u.style.left = t + 'px'), (p.style.width = t + 'px'));
                    }, 16);
                }
            ...
            function d(e) {
              if (f) {
                ...
                if ((a = t('J_LoginBox') || t('J_Login') || h.getElementsByClassName('nc-outer-box')[0])) {
                  ...
                  var x, w;
                  (w = t(g + 'imgCaptcha')),
                    w && ((w.style.top = y + c + 'px'), (x = v - c - 66), b && (x -= 13), b || 0 !== s() || ((w.style.minHeight = '290px'), (x -= 10)), (w.style.height = x + 'px'), b && (w.style.minHeight = 0)),
                    (w = t(g + 'clickCaptcha')),
                    w && ((w.style.top = y + c + 'px'), p ? (l(), (x = v + 30), x < 255 && (x = 255), (w.style.height = x + 'px')) : (l(), (x = v - c - 30), b && (x -= 8), (w.style.height = x + 'px')), b && (w.style.minHeight = 0));
                }
              }
            }
            function u(e, t, n) {
                ...
                i(e, [
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      ...
                      l.log({ a: o.appkey, t: i, scene: o.scene, ns: '', jsv: this.jsv, usa: navigator.userAgent, p: n, jsType: 'pc', os: c.getOS(), em: t, ec: e });
                    },
                  },
                ]),
                e
                ...
                _createClass(Scrape, [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this;
                      Report.log(
                        { a: t.options.appkey, t: t.options.token, ns: UA_VERSION, jsv: t.nc.inn_vars.v, scene: t.options.scene, jsType: t.nc.inn_vars.js_type, usa: navigator.userAgent, os: util.getOS(), p: e || '' },
                    ...
                    value: function () {
                      ...
                      for (var i = cfg.grid_size, r = Math.ceil(n / i), a = Math.ceil(o / i), c = [], s = this.options.bg_back, l = 0; l < a; l++)
                        for (var d = 0; d < r; d++) {
                          var u = i * l,
                            p = i * d,
                            _ = { width: i + 'px', height: i + 'px', top: u + 'px', left: p + 'px', 'background-image': 'url(' + s + ')', 'background-position': '-' + p + 'px -' + u + 'px' },
                            f = this.mkGridId(d, l),
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      (n.fillStyle = '#fff'),
                        ...
                        n.fill(),
                        this._last_x >= 0 && this._last_y >= 0 && (n.beginPath(), (n.lineWidth = this.stroke_size), n.moveTo(this._last_x, this._last_y), n.lineTo(e, t), n.stroke()),
                        (this._last_x = e),
                        (this._last_y = t);
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var i = this.is_downgraded ? 0.7 : 0.9,
                        r = (this.obj_w / 2) * i,
                        a = (this.obj_h / 2) * i;
                      return (
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      if ((e > 0.9 || n) && window.__sc__uab.isReadyForSC(window.__sc_uaboption.mIDs)) this.verify();
                      else if (e > 0.9 && n) {
                        try {
                        } catch (o) {}
                        win._n_bak = win._n;
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return (
                        o.failCallback && o.failCallback('{code: ' + a + ', str:' + r + '}'),
                        {
                          type: i,
                          str: r
                            .map(function (e) {
                        ...
                        var a = this,
                          c = function s() {
                            return a.scrapeStart
                              ...
                              : ((a.showingHow = !0),
                                void (o < r
                                  ? ((e.style.left = t[o][0] + 'px'), (e.style.top = t[o][1] + 5 + 'px'), 0 == o && a.render_surface(), a._clearTo(t[o][0] + 20, t[o][1] + 5), o++, setTimeout(s, 10))
                                  : (i++, i < n ? ((a._last_x = -1), (a._last_y = -1), (o = 0), setTimeout(s, 500)) : ((a._last_x = -1), (a._last_y = -1), (e.style.display = 'none'), a.render_surface(), (a.showingHow = !1)))));
                          };
                        c();
                      }
                    },
                    ...
                    value: function () {
                      ...
                      return new Promise(function (t, n) {
                        try {
                          var o = e.nc;
                          if (
                            ((e.root.innerHTML = kvTpl.render(html, { nc: o, prefix: e.prefix, inform: '', loading: e._lang._ggk_loading, obj_ok: e.options.obj_ok, obj_error: e.options.obj_error })),
                            e.showEl('loading'),
                            e.hideEl('load-error'),
                            ...
                            return e.downgrade(), e.render_surface_dg(), void t();
                          e.render_surface(), t();
                        } catch (i) {
                          n(i);
                        }
                ...
                : window.AWSC &&
                  ...
                  window.AWSC.use(
                    ...
                    function (t, n) {
                      if ('loaded' === t)
                        try {
                          umx.init({ timeout: e.timeout, token: e.token, serviceUrl: c.umid_serUrl, appName: e.appkey, enableFY: 1, jf: 1, wtac: 1 }), o();
                        } catch (i) {
                          o(i);
                        }
                      else o(u);
